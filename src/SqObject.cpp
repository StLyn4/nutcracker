...
// ***********************************************************************************************************************
int SqObject::GetType(void) const { return m_type; }
...
const std::string& SqObject::GetString(void) const {
  if (m_type != TypeString && m_type != TypeNull) throw Error("Request of String in object of type %s.", GetTypeName());
...
float SqObject::GetFloat(void) const {
  if (m_type != TypeFloat && m_type != TypeNull) throw Error("Request of Float in object of type %s.", GetTypeName());
